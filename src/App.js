...
function App() {
  ...
  return (
    ...
    <RadioGroup aria-label="gender" name="Category" value={categoryValue} onChange={handleChange}>
        ...
        <div>
        <TextField id="standard-basic" label="Training Data Percentage" className="text-field"/>
        <InfoIcon/>
        </div>
        <div>
        <TextField id="standard-basic" label="Text Data Percentage" className="text-field" />
        <InfoIcon/>
        </div>
        <div>
        <TextField id="standard-basic" label="Maximum Depth of Tree" className="text-field" />
        <InfoIcon/>
        </div>
        <div>
        <TextField id="standard-basic" label="Maximum number of bins" className="text-field" />
        <InfoIcon/>
        </div>
    </FormControl>
    </form>
